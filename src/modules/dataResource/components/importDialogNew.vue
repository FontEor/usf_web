    ...
    <template v-if="showLittleInit">
      ...
      <div class="showLittleInit">
        ...
        <el-upload
          ...
          :action="`${VUE_APP_API_PREFIX}${this.uploadData.uploadUrl}?tenementCode=${$store.state.app.tenementCode}&dataTypeId=${this.state.typeId}`"
          :auto-upload="true"
...
export default {
  ...
  methods: {
    ...
    submitDown() {
      ...
      _form.action = `${_origin}${this.VUE_APP_API_PREFIX}/dataBaseBatch/downloadTemplate.do?tenementCode=${this.$store.state.app.tenementCode}&templateType=${this.uploadData.templateType}&typeId=${this.state.typeId}`;
      _form.method = "post";
