<template>
  <div :class="['sidebar', fold ? 'sidebar-fold' : undefined]">
    <div :class="[`sidebar-logo-block-${edition}`]">
      <span font>USF3权限系统</span>

      <!--todo-->
      <!--<img src="../../../imgs/title@2x.png" alt="" style="width: 100px;height: auto">-->
    </div>
    ...
    <!-- <a @click="toggleFold">
      <div class="sidebar-fold-block" v-if="$route.meta.showSd !== false">
        <span
          :class="[
            'sidebar-fold-btn',
            fold ? 'el-icon-caret-right' : 'el-icon-caret-left',
          ]"
        ></span>
      </div>
    </a> -->
...
.sidebar {
  ...
  // 更改左上角的字体
  .sidebar-logo-block-old {
    height: $--tb-height;
    border-bottom: 1px solid rgba(119, 140, 162, 0.3);
